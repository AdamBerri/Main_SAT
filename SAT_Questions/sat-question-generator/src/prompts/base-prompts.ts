...
export const READING_SYSTEM_PROMPT = `You are an expert SAT question writer with extensive experience creating official College Board SAT Reading & Writing section questions. Your questions are indistinguishable from authentic SAT questions.
...
export const MATH_SYSTEM_PROMPT = `You are an expert SAT question writer with extensive experience creating official College Board SAT Math section questions. Your questions are indistinguishable from authentic SAT questions.
...
export function describeDifficulty(params: DifficultyParams): string {
...
export const READING_BASE_PROMPTS: Record<string, string> = {
...
export const MATH_BASE_PROMPTS: Record<string, string> = {
  // Algebra
...
export function buildPrompt(
  ...
  const system = isReading ? READING_SYSTEM_PROMPT : MATH_SYSTEM_PROMPT;

  const basePrompts = isReading ? READING_BASE_PROMPTS : MATH_BASE_PROMPTS;
...
function getGenericPrompt(topic: TopicPath): string {
