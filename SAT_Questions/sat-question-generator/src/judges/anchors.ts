...
export const FAITHFULNESS_ANCHORS: AnchorSet = {
  id: 'faithfulness_v1',
...
export const ANSWER_VALIDITY_ANCHORS: AnchorSet = {
...
export const DISTRACTOR_QUALITY_ANCHORS: AnchorSet = {
...
export const DIFFICULTY_ACCURACY_ANCHORS: AnchorSet = {
...
export const FRONTEND_CONVERTIBILITY_ANCHORS: AnchorSet = {
...
export const IMAGE_QUALITY_ANCHORS: AnchorSet = {
  id: 'image_quality_v1',
...
export const GRAMMAR_AUTHENTICITY_ANCHORS: AnchorSet = {
...
export const ANCHOR_SETS: Record<EvaluationDimension, AnchorSet> = {
  faithfulness: FAITHFULNESS_ANCHORS,
  answer_validity: ANSWER_VALIDITY_ANCHORS,
  distractor_quality: DISTRACTOR_QUALITY_ANCHORS,
  difficulty_accuracy: DIFFICULTY_ACCURACY_ANCHORS,
  frontend_convertibility: FRONTEND_CONVERTIBILITY_ANCHORS,
  image_quality: IMAGE_QUALITY_ANCHORS,
  grammar_authenticity: GRAMMAR_AUTHENTICITY_ANCHORS,
};

// Get anchor set for a dimension
export function getAnchorSet(dimension: EvaluationDimension): AnchorSet {
  return ANCHOR_SETS[dimension];
}
